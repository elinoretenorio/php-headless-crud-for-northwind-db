...
use Northwind\OrderDetails\{ OrderDetailsDto, OrderDetailsModel, OrderDetailsController };
...
class OrderDetailsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("Northwind\OrderDetails\IOrderDetailsService");
    ...
    public function testGet_ReturnsResponse(): void
    {
        ...
        $args = ["order_details_id" => 3524];

        $this->service->expects($this->once())
            ->method("get")
            ->with($args["order_details_id"])
            ->willReturn($this->model);
