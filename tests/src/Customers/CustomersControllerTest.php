...
use Northwind\Customers\{ CustomersDto, CustomersModel, CustomersController };
...
class CustomersControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = $this->createMock("Northwind\Customers\ICustomersService");
